...
public class ThongBaoHDDonGianAdapter extends RecyclerView.Adapter<ThongBaoHDDonGianAdapter.ThongBaoViewHolder> {

    private List<ThongBaoHDDonGian> danhSach;
    private Context context;
    private OnThongBaoClickListener listener;

    public interface OnThongBaoClickListener {
        void onClick(ThongBaoHDDonGian thongBao);
    }

    public ThongBaoHDDonGianAdapter(List<ThongBaoHDDonGian> danhSach, Context context, OnThongBaoClickListener listener) {
        this.danhSach = danhSach;
        this.context = context;
        this.listener = listener;
    }

    public void capNhatDuLieu(List<ThongBaoHDDonGian> danhSachMoi) {
    ...
    public void onBindViewHolder(@NonNull ThongBaoViewHolder holder, int position) {
        ThongBaoHDDonGian thongBao = danhSach.get(position);
