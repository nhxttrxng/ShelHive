...
import com.nhom5.shelhive.ui.admin.hoadon.Admin_RoomListActivity;
...
public class Admin_PhanAnh_NhaTro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_phananh_nhatro);
                ...
                .enqueue(new Callback<List<GetMotelResponse>>() {
                    ...
                    public void onResponse(Call<List<GetMotelResponse>> call, Response<List<GetMotelResponse>> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            Toast.makeText(Admin_PhanAnh_NhaTro.this, "Không tải được danh sách!", Toast.LENGTH_SHORT).show();
                            updateEmptyState();
                        }
                    }
                    ...
                    public void onFailure(Call<List<GetMotelResponse>> call, Throwable t) {
                        ...
                        Toast.makeText(Admin_PhanAnh_NhaTro.this, "Lỗi kết nối!", Toast.LENGTH_SHORT).show();
                        updateEmptyState();
                    }
                });
    }
