...
public class Admin_HoaDonActivity extends AppCompatActivity {
    ...
    private void loadMotelData() {
        ...
        nhaTroList.add(new Motel("Nhà trọ Trường Phát 1", "số 41, đường N4, p. Mỹ Phước, tp. Bến Cát, Bình Dương", 1));
        nhaTroList.add(new Motel("Nhà trọ Trường Phát 2", "số 42, đường N4, p. Mỹ Phước, tp. Bến Cát, Bình Dương", 0));
