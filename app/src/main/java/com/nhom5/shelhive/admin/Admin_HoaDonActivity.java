...
public class Admin_HoaDonActivity extends AppCompatActivity {
    ...
    private void setupRoomListeners() {
        ...
        room1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_HoaDonActivity.this, "Phòng 1 - Ngô Nhựt Trường", Toast.LENGTH_SHORT).show();
        ...
        room2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_HoaDonActivity.this, "Phòng 2 - Trần Danh Vinh", Toast.LENGTH_SHORT).show();
        ...
        room3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_HoaDonActivity.this, "Phòng 3 - Trần Thảo Quyên", Toast.LENGTH_SHORT).show();
